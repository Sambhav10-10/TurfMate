...
const userSchema = new mongoose.Schema({
    ...
    phone: { type: String, default: '000000000', index: true },
    address: { type: Object, default: { line1: '', line2: '' } },
    gender: { type: String, default: 'Not Selected' },
    dob: { type: String, default: 'Not Selected' },

    // IMPROVEMENT #4: Enhanced rating system with abuse prevention
    // Tracks which match the rating is for, plus timestamps
    ratings: {
        type: [{
            raterId: String,
            rating: Number,
            matchId: String,  // Track which match this rating is from (IMPROVEMENT #4)
    ...
    // IMPROVEMENT #1: Track pending reservations for abuse prevention
    // Limits to max 3 pending reservations per user to prevent spam
    pendingReservations: [String],  // Array of match IDs with pending reservations

    password: { type: String, required: true }
}, { timestamps: true });

// IMPROVEMENT #6: Add indexes on frequently queried fields for performance
