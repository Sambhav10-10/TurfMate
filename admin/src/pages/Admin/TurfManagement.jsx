                ...
                {!loading && filteredTurfs.length > 0 && !showForm && (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredTurfs.map(turf => (
                            <div key={turf._id} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition">
                                {/* Card Header */}
                                <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-4 text-white">
                                    <h3 className="text-xl font-bold">{turf.name}</h3>
                                    <p className="text-blue-100 text-sm mt-1">{turf.city}</p>
                                </div>
                                ...
                                <div className="p-4 space-y-3">
                                    ...
                                    {/* Status Badge */}
                                    <div className="pt-2">
                                        <span className={`text-xs font-semibold px-3 py-1 rounded-full ${turf.verified ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'
                                            }`}>
                                            {turf.verified ? 'Verified' : 'Pending Verification'}
                                        </span>
                                    </div>
                                </div>
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                        <div className="bg-white rounded-lg shadow-2xl max-w-md w-full max-h-96 overflow-y-auto">
                            <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-6 text-white">
                                ...
                                <p className="text-blue-100">{selectedTurfDetails.city}</p>
                            </div>
                            ...
                            <div className="p-6 space-y-4">
                                ...
                                <div className="bg-blue-50 p-3 rounded">
                                    ...
                                    <p className={selectedTurfDetails.verified ? 'text-green-600 font-medium' : 'text-yellow-600 font-medium'}>
                                        {selectedTurfDetails.verified ? 'Verified' : 'Pending Verification'}
                                    </p>
                                </div>
                            </div>
